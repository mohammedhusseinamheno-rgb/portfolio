  ...
  return (
    <content className="content w-full h-full flex flex-col items-center justify-center gap-8">
        <section id="intro" className="intro p-8 gap-y-2 h-screen md:w-1/2 flex justify-center flex-col items-start">
            ...
            <div className="socials flex justify-around flex gap-2 text-1xl font-mono text-left w-full">
                <a href="https://www.instagram.com/964.m7md/" target="_blank" rel="noopener noreferrer" className="hover:bg-orange-500 rounded bg-sky-500 text-base text-1xl md:text-2xl p-2 w-1/3 hover:scale-102">Instagram</a>
                <a href="https://www.linkedin.com/in/mohammed-hussein-amheno-604494407?utm_source=share_via&utm_content=profile&utm_medium=member_androidhttps://www.linkedin.com/in/mohammed-hussein-amheno-604494407" target="_blank" rel="noopener noreferrer" className="hover:bg-white rounded bg-sky-500 text-1xl md:text-2xl text-base p-2 w-1/3 hover:scale-102">Linkedin</a>
                <a href="https://www.youtube.com/@eng.m7" target="_blank" rel="noopener noreferrer" className="hover:bg-red-500 hover:text-white rounded bg-sky-500 text-base text-1xl md:text-2xl p-2 w-1/3 hover:scale-101">YouTube</a>
            </div>
        </section>
        ...
        <section id="contact" className="contact p-8 gap-2 h-screen w-full md:w-1/2 flex justify-center flex-col items-start">
            <h1 className="text-2xl md:text-3xl font-poppins text-left font-bold text-sky-500 underline underline-offset-6">Get in touch</h1>
            <p className="text-1xl md:text-2xl font-mono text-justify">
            ...
            <div className="socials flex flex-col justify-around  gap-2 text-1xl md:text-2xl font-mono text-left w-full padding-2">
                <p>Discord: 7medi</p>
                <p>Email: mohammedhusseinamheno@gmail.com</p>
